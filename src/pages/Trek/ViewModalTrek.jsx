...
export default function ViewModalTrek ({viewData,setModal}) {
  ...
  >
    ...
    <tbody className="text-gray-600">
      <tr>
        <td className="py-2 px-4 border border-gray-300">Trek Name</td>
      ...
      <tr>
        <td className="py-2 px-4 border border-gray-300">Trek Thumbnail</td>
        <td className="py-2 px-4 border border-gray-300">{viewData ? <img src={viewData?.trekLogo}  className="rounded-lg h-32 w-52" /> : ''}</td>
      </tr>
   

      <tr>
        <td className="py-2 px-4 border border-gray-300">Season</td>
        <td className="py-2 px-4 border border-gray-300">
        
        {viewData?.season?.map((item,idx)=>
            <span className='me-5 bg-slate-100 mb-2 rounded-md px-2'>{item}</span>
        )}
      ...
      <tr>
        <td className="py-2 px-4 border border-gray-300">Difficulty</td>
        <td className="py-2 px-4 border border-gray-300">
      ...
      <tr>
        <td className="py-2 px-4 border border-gray-300">Altitude</td>
        <td className="py-2 px-4 border border-gray-300">
        
        {viewData ?  viewData?.altitude : ''}
          
        </td>
      </tr>
      <tr>
        <td className="py-2 px-4 border border-gray-300">Age Limit</td>
        <td className="py-2 px-4 border border-gray-300">
        {viewData ?  viewData?.ageLimit : ''}
        </td>
      </tr>
